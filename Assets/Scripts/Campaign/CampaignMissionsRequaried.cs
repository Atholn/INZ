...
public static class CampaignMissionsRequaried
{
    public static void SetRequired(int number)
    {
        switch (number)
        {
            ...
            case 4:
                MapToPlayStorage.AddBuildingRequaried(2, 1);
                ...
                break;
            case 5:
                MapToPlayStorage.AddBuildingRequaried(4, 1);
                MapToPlayStorage.AddUpgradesRequaried(0, true); 
                break;
            ...
            case 13: MapToPlayStorage.AddDominateRequaried(false); break;
            case 14: MapToPlayStorage.AddDominateRequaried(true); break;
